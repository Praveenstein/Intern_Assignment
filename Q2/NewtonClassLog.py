...
class Newton:
    ...
    def _newton(self):
        ...
        for i in range(0, self.max_iter):
            ...
            self.data += f"Iteration: {i}\nValue of Xn: {round(xn, 5)}\nValue of Function(Xn): {round(fxn, 5)} " + \
                         f"\nValue of Derivative-Function(Xn): {round(dfxn, 5)}\nThe residual error: {round(error, 5)}" + \
                         "\n-------------------------------------------------\n"
